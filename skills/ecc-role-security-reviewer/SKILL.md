---
name: ecc-role-security-reviewer
description: "Role skill for 'security-reviewer'. Use when tasks need security review, vulnerability detection, and hardening; review specialist role outputs with role-scoped deliverables."
---

# ecc-role-security-reviewer

Perform threat-focused security review with actionable fixes.

## Role Workflow

1. Restate objective through the `security-reviewer` lens.
