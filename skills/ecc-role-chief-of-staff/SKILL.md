---
name: ecc-role-chief-of-staff
description: "Role skill for 'chief-of-staff'. Use when tasks need cross-workstream coordination and prioritization; operational planning and decision support with role-scoped deliverables."
---

# ecc-role-chief-of-staff

Coordinate multi-thread work, priorities, and decision summaries.

## Role Workflow

1. Restate objective through the `chief-of-staff` lens.
