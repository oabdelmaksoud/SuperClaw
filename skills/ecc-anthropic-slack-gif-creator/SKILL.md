---
name: ecc-anthropic-slack-gif-creator
description: "Bridge skill for anthropics/skills 'slack-gif-creator'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---

# ecc-anthropic-slack-gif-creator

Apply upstream Anthropic skill intent in OpenClaw-native execution.

## Source
- `upstream-import/anthropic-skills/references/skills/slack-gif-creator`
