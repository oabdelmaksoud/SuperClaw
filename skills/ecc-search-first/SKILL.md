...
description: "Domain skill for 'search-first'. Use when requests involve search-first exploration and evidence gathering; AI-first implementation approaches."
---
