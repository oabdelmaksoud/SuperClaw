...
description: "OpenClaw bridge skill for marketing skill schema markup. Use when tasks match this specialized anthropic skills capability and need OpenClaw-native execution with explicit verification."
---

# ecc-claude-marketing-skill-schema-markup

## Purpose
Apply `marketing skill schema markup` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `marketing skill schema markup` capability.
...
- Requests unrelated to `marketing skill schema markup` specialization.
