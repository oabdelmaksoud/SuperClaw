---
name: ecc-anthropic-algorithmic-art
description: "Bridge skill for anthropics/skills 'algorithmic-art'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---

# ecc-anthropic-algorithmic-art

Apply upstream Anthropic skill intent in OpenClaw-native execution.

## Source
- `upstream-import/anthropic-skills/references/skills/algorithmic-art`
