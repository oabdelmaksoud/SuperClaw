...
description: "OpenClaw bridge skill for c level advisor chro advisor. Use when tasks match this specialized anthropic skills capability and need OpenClaw-native execution with explicit verification."
---

# ecc-claude-c-level-advisor-chro-advisor

## Purpose
Apply `c level advisor chro advisor` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `c level advisor chro advisor` capability.
...
- Requests unrelated to `c level advisor chro advisor` specialization.
