...
## Purpose
Apply `ra qm team information security manager iso27001` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `ra qm team information security manager iso27001` capability.
...
- Requests unrelated to `ra qm team information security manager iso27001` specialization.
