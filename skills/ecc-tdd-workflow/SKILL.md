...
description: "Domain skill for 'tdd-workflow'. Use when requests involve test-driven development (red-green-refactor); workflow design, execution sequencing, and checkpoints."
---
