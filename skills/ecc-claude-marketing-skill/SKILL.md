...
description: "OpenClaw bridge skill for marketing skill. Use when tasks match this specialized anthropic skills capability and need OpenClaw-native execution with explicit verification."
---

# ecc-claude-marketing-skill

## Purpose
Apply `marketing skill` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `marketing skill` capability.
...
- Requests unrelated to `marketing skill` specialization.
