...
description: "Domain skill for 'project-guidelines-example'. Use when requests involve project-level conventions and operational guidelines; project standards and conventions."
---

# ecc-project-guidelines-example
