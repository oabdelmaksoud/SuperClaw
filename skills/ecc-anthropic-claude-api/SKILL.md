---
name: ecc-anthropic-claude-api
description: "Bridge skill for anthropics/skills 'claude-api'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---

# ecc-anthropic-claude-api

Apply upstream Anthropic skill intent in OpenClaw-native execution.

## Source
- `upstream-import/anthropic-skills/references/skills/claude-api`
