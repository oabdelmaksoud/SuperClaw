---
name: ecc-role-refactor-cleaner
description: "Role skill for 'refactor-cleaner'. Use when tasks need behavior-preserving refactoring and cleanup; cleanup and refactor discipline role with role-scoped deliverables."
---

# ecc-role-refactor-cleaner

Refactor code behavior-safely with incremental verification.

## Role Workflow

1. Restate objective through the `refactor-cleaner` lens.
