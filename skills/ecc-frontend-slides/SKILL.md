...
description: "Domain skill for 'frontend-slides'. Use when requests involve frontend UI/state/performance/accessibility workflows; HTML/PPT-style slide generation workflows."
---
