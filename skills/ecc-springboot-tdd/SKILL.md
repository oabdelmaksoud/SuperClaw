...
description: "Domain skill for 'springboot-tdd'. Use when requests involve Spring Boot architecture/security/testing workflows; test-driven development (red-green-refactor)."
---
