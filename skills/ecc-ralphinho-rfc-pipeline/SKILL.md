...
description: "Domain skill for 'ralphinho-rfc-pipeline'. Use when requests involve RFC pipeline style workflow; RFC writing/review and decision workflows; pipeline architecture and staged processing."
---
