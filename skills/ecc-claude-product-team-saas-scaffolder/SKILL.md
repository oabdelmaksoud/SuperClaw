...
## Purpose
Apply `product team saas scaffolder` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `product team saas scaffolder` capability.
...
- Requests unrelated to `product team saas scaffolder` specialization.
