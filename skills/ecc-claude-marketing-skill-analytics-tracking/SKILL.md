---
name: ecc-claude-marketing-skill-analytics-tracking
description: "OpenClaw bridge skill for marketing skill analytics tracking. Use when tasks match this specialized anthropic skills capability and need OpenClaw-native execution with explicit verification."
---

# ecc-claude-marketing-skill-analytics-tracking

## Purpose
Apply `marketing skill analytics tracking` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `marketing skill analytics tracking` capability.
...
- Requests unrelated to `marketing skill analytics tracking` specialization.
