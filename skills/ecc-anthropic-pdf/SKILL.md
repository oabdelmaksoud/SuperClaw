---
name: ecc-anthropic-pdf
description: "Bridge skill for anthropics/skills 'pdf'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---
...
## Source
- `upstream-import/anthropic-skills/references/skills/pdf`
