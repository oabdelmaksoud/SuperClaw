---
name: ecc-anthropic-frontend-design
description: "Bridge skill for anthropics/skills 'frontend-design'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---

# ecc-anthropic-frontend-design

Apply upstream Anthropic skill intent in OpenClaw-native execution.

## Source
- `upstream-import/anthropic-skills/references/skills/frontend-design`
