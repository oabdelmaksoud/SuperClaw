---
name: ecc-api-design
description: "Domain skill for 'api-design'. Use when requests involve API design, contracts, interface evolution, and integration; product/system design and implementation tradeoffs."
---
