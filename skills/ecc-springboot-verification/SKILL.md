...
description: "Domain skill for 'springboot-verification'. Use when requests involve Spring Boot architecture/security/testing workflows; verification-focused execution and evidence reporting."
---
