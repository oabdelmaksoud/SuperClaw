---
name: ecc-anthropic-mcp-builder
description: "Bridge skill for anthropics/skills 'mcp-builder'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---

# ecc-anthropic-mcp-builder

Apply upstream Anthropic skill intent in OpenClaw-native execution.

## Source
- `upstream-import/anthropic-skills/references/skills/mcp-builder`
