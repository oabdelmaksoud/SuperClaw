...
description: "Domain skill for 'regex-vs-llm-structured-text'. Use when requests involve regex-based extraction and parsing approaches; comparative method selection; LLM pipeline design and optimization; structured data/text extraction."
---
