---
name: ecc-role-doc-updater
description: "Role skill for 'doc-updater'. Use when tasks need documentation/status update specialist role with role-scoped deliverables."
---

# ecc-role-doc-updater

Keep docs synchronized with implementation and workflows.

## Role Workflow

1. Restate objective through the `doc-updater` lens.
