---
name: ecc-anthropic-internal-comms
description: "Bridge skill for anthropics/skills 'internal-comms'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---

# ecc-anthropic-internal-comms

Apply upstream Anthropic skill intent in OpenClaw-native execution.

## Source
- `upstream-import/anthropic-skills/references/skills/internal-comms`
