...
## Purpose
Apply `ra qm team quality manager qms iso13485` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `ra qm team quality manager qms iso13485` capability.
...
- Requests unrelated to `ra qm team quality manager qms iso13485` specialization.
