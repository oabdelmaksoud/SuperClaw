...
description: "Domain skill for 'swift-actor-persistence'. Use when requests involve Swift/SwiftUI/concurrency engineering workflows; actor-model concurrency and persistence patterns; state persistence/reliability patterns."
---
