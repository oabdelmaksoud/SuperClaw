...
description: "Domain skill for 'golang-testing'. Use when requests involve Go/Golang architecture, testing, and code quality; testing strategy, reliability, and maintenance."
---
