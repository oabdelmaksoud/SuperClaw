...
description: "Domain skill for 'agent-harness-construction'. Use when requests involve agent behavior design and orchestration; agent harness configuration, performance, and reliability tuning; building new framework/skill infrastructure."
---
