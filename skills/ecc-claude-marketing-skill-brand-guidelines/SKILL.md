...
description: "OpenClaw bridge skill for marketing skill brand guidelines. Use when tasks match this specialized anthropic skills capability and need OpenClaw-native execution with explicit verification."
---

# ecc-claude-marketing-skill-brand-guidelines

## Purpose
Apply `marketing skill brand guidelines` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `marketing skill brand guidelines` capability.
...
- Requests unrelated to `marketing skill brand guidelines` specialization.
