---
name: ecc-role-planner
description: "Role skill for 'planner'. Use when tasks need specialized OpenClaw workflow execution; structured outputs with verification with role-scoped deliverables."
---

# ecc-role-planner

Create phased implementation plans and wait for approval gates.

## Role Workflow

1. Restate objective through the `planner` lens.
