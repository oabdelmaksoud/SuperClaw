...
description: "Domain skill for 'database-migrations'. Use when requests involve database schema/query/migration correctness and safety; migration planning, rollout safety, and rollback readiness."
---
