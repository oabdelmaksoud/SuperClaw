---
name: ecc-anthropic-web-artifacts-builder
description: "Bridge skill for anthropics/skills 'web-artifacts-builder'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---

# ecc-anthropic-web-artifacts-builder

Apply upstream Anthropic skill intent in OpenClaw-native execution.

## Source
- `upstream-import/anthropic-skills/references/skills/web-artifacts-builder`
