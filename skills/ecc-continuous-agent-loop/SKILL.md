...
description: "Domain skill for 'continuous-agent-loop'. Use when requests involve continuous improvement and continuous execution loops; agent behavior design and orchestration; bounded iterative execution cycles."
---
