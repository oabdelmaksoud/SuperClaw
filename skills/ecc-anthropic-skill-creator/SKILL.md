---
name: ecc-anthropic-skill-creator
description: "Bridge skill for anthropics/skills 'skill-creator'. Use when this specialized capability is requested; execute with OpenClaw-native tools and verification."
---

# ecc-anthropic-skill-creator

Apply upstream Anthropic skill intent in OpenClaw-native execution.

## Source
- `upstream-import/anthropic-skills/references/skills/skill-creator`
