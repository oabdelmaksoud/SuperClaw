...
description: "OpenClaw bridge skill for marketing skill marketing ops. Use when tasks match this specialized anthropic skills capability and need OpenClaw-native execution with explicit verification."
---

# ecc-claude-marketing-skill-marketing-ops

## Purpose
Apply `marketing skill marketing ops` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `marketing skill marketing ops` capability.
...
- Requests unrelated to `marketing skill marketing ops` specialization.
