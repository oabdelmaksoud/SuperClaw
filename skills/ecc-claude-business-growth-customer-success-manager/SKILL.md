...
## Purpose
Apply `business growth customer success manager` guidance from upstream references in an OpenClaw-native workflow.

## Trigger Conditions
- User request clearly matches `business growth customer success manager` capability.
...
- Requests unrelated to `business growth customer success manager` specialization.
