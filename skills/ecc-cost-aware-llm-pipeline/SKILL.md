...
description: "Domain skill for 'cost-aware-llm-pipeline'. Use when requests involve cost-aware optimization for model/tool usage; tradeoff-aware decision making; LLM pipeline design and optimization; pipeline architecture and staged processing."
---
